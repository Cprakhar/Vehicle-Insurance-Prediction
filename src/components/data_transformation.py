...
from src.constants import TARGET_COLUMN, SCHEMA_FILEPATH
...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            train_df = self.read_data(filepath=self.data_ingestion_artifact.training_filepath)
            test_df = self.read_data(filepath=self.data_ingestion_artifact.testing_filepath)
