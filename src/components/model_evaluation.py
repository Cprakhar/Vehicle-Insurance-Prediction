...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[VehicleInsuranceEstimator]:
        ...
        try:
            ...
            vehicle_insurance_estimator = VehicleInsuranceEstimator(bucket_name=bucket_name,
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        """
        try:
            test_df = pd.read_csv(self.data_ingestion_artifact.testing_filepath)
            ...
            trained_model = load_object(filepath=self.model_trainer_artifact.trained_model_filepath)
