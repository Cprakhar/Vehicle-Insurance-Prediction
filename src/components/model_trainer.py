...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            preprocessing_obj = load_object(filepath=self.data_transformation_artifact.transformed_object_filepath)
            ...
            save_object(self.model_trainer_config.trained_model_filepath, my_model)
