import boto3
import os
from src.constants import AWS_SECRET_ACCESS_KEY_ENV_KEY, AWS_ACCESS_KEY_ENV_KEY, REGION_NAME
    ...
    def __init__(self, region_name=REGION_NAME):
        ...
        if S3Client.s3_resource==None or S3Client.s3_client==None:
            ...
            if __access_key_id is None:
                raise Exception(f"Environment variable: {AWS_ACCESS_KEY_ENV_KEY} is not not set.")
